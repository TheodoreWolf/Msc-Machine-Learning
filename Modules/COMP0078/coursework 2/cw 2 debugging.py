...
#alg = algorithms(algorithm="least squares", max_dims=100, number_of_training_sets=100, test_set_size=200)
#alg = algorithms(algorithm="winnow", max_dims=100, number_of_training_sets=100, test_set_size=200)
#alg = algorithms(algorithm="perceptron", max_dims=100, number_of_training_sets=100, test_set_size=200)
alg = algorithms(algorithm="1-nn", max_dims=20, number_of_training_sets=20, test_set_size=50)
